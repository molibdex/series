(function (global, factory) {
	...
	// external dependencies
	var O = Object;
	var create$1 = O.create, getOwnPropertySymbols = O.getOwnPropertySymbols, getPrototypeOf = O.getPrototypeOf, keys$1 = O.keys, propertyIsEnumerable = O.propertyIsEnumerable;
	 ...
	 */
	var createWithProto = function (object) { return create$1(object.__proto__ || getPrototypeOf(object)); };
	/**
	...
	var createIdentitySelector = function (path) {
	    ...
	    if (isUnchangedPath(path, type)) {
	        return function (state) { return get(path, state); };
	    }
	    if (isObjectPath(path, type)) {
	        if (hasOwnProperty.call(path, 'path') &&
	            ...
	            return function () {
	                return get(path.path, selectorIdentity_1.apply(null, arguments));
	            };
	        }
	...
	var getStructuredObject = function (properties) { return function () {
	    ...
	    return properties.reduce(function (structuredObject, property, index$$1) {
	        structuredObject[property] = values[index$$1];
	...
	function findNonSerializableValue(value) {
	  ...
	  for (var _i = 0; _i < _arr.length; _i++) {
	    ...
	    if (_typeof$1(nestedValue) === 'object') {
